...
export function ImageBanner({
  ...
  return (
    <section className="relative flex min-h-[clamp(420px,56vh,560px)] items-center overflow-hidden">
      ...
      <div className="container-1200 relative z-[1] flex justify-end py-[clamp(48px,7vw,96px)]">
        <Reveal className="max-w-[530px] text-right">
          <p className="mb-5 flex items-center justify-end gap-3.5 font-mono text-[12.5px] uppercase tracking-[.16em] text-gold-pale">
            {eyebrow}
